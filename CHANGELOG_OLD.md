...
- feat: Implemented `huntSmallerSnakes` in `src/utils/moves/huntSmallerSnakes.js` and integrated it into the move decision pipeline in `src/core/snake.js`. The snake now hunts and attacks smaller snakes when possible.
